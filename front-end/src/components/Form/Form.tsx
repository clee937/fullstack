  ...
  return (
    <div className="form-container">
      ...
      <form className="form-container__form" onSubmit={handleValidation}>
        ...
        />
        <section className="form-container__field">
          <label className="form-container__label" htmlFor="onomatopoeia">
            Onomatopoeia:
          </label>
          <input
            id="onomatopoeia"
        ...
        <section className="form-container__field">
          <label className="form-container__label" htmlFor="meaning">
            Meaning:
          </label>
          <input
            id="meaning"
        ...
        <section className="form-container__field">
          <label className="form-container__label" htmlFor="exampe">
            Example:
          </label>
          <input
            id="example"
